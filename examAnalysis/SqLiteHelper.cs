...
namespace examAnalysis
{
    ...
    class SqLiteHelper
    {
        ...
        /// <returns>The full table.</returns>
        /// <param name="tableName">数据表名称</param>
        public SQLiteDataReader ReadFullTableWithParam(string tableName, string[] colNames, string[] operations, string[] colValues)
        {
            string queryString = "SELECT * FROM " + tableName;
        ...
        /// <returns>The full table.</returns>
        /// <param name="tableName">数据表名称</param>
        public SQLiteDataReader ReadFullTableWithParamAndGroupBy(string tableName, string item,string[] colNames, string[] operations, string[] colValues)
        {
            string queryString = "SELECT COUNT(*)," +item +" FROM " + tableName;
            queryString += " WHERE " + colNames[0] + " " + operations[0] + " " + "'" + colValues[0] + "'";
            for (int i = 1; i < colNames.Length; i++)
            {
                queryString += " AND " + colNames[i] + " " + operations[i] + " " + "'" + colValues[i] + "'";
            };
            queryString += " GROUP BY " + item;
            return ExecuteQuery(queryString);
        }
        ...
        public SQLiteDataReader ReadTable(string tableName, string[] items, string hasquery,string[] colNames, string[] operations, string[] colValues)
        {
